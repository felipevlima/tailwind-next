interface UsedSpaceWidgetProps {
  handleDismissWidget: () => void
}

export function UsedSpaceWidget({ handleDismissWidget }: UsedSpaceWidgetProps) {
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5">
      <div className="space-y-1">
        ...
        <div className="space-x-3">
          ...
          <button className="text-sm font-medium text-violet-500 hover:text-violet-800">
            Upgrade
          </button>
        </div>
      </div>
